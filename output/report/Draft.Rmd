...
We first conducted some descriptive analysis and then proceed with a chi-square test as we had categorical variables. To see if the analysis was robust or there are other variables that may evidence a correlation, we conducted a regression model for controlling variables.


To measure the percentages of the two variables toghether we created a cross-table with percentages.
